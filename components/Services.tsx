  ...
  return (
    <section id="services" className="section-padding section-gradient-cream relative overflow-hidden" ref={ref}>
      ...
      <div className="container-max relative z-10">
        ...
        <div className={`gradient-navy p-8 md:p-10 rounded-2xl flex flex-col md:flex-row items-start md:items-center gap-8 relative overflow-hidden transition-all duration-700 delay-500 ${visible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
          <div className="absolute top-0 right-0 w-60 h-60 bg-gold/5 rounded-full blur-3xl" />
          ...
          <Link href="/prendre-rendez-vous" className="relative z-10 inline-flex items-center gap-2 bg-gradient-to-r from-gold to-gold-light text-navy font-bold px-6 py-3 rounded-full text-sm transition-all hover:shadow-[0_8px_30px_rgba(201,168,76,0.4)] hover:-translate-y-1 flex-shrink-0">
            Prendre contact
          </Link>
        </div>
      </div>
