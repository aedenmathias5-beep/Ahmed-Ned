      ...
      <main>
        <section className="section-padding bg-white dark:bg-gray-950" style={{ paddingTop: '140px' }}>
          <div className="container-max">
            ...
            <p className="text-lg max-w-2xl mb-12 text-muted dark:text-gray-400">
            ...
            <div className="bg-gradient-to-br from-navy to-[#0F2D4A] rounded-3xl p-8 md:p-10 mb-16">
              <div className="flex items-center gap-3 mb-6">
                <span className="text-2xl">💳</span>
                <div>
                  <h2 className="text-2xl font-bold text-white">Moyens de paiement</h2>
                  <p className="text-white/60 text-sm">Paiement sécurisé — plusieurs options disponibles</p>
                </div>
              </div>

              <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 gap-3 mb-8">
                <div className="flex flex-col items-center justify-center bg-white rounded-xl p-4 h-20 shadow-sm">
                  <svg viewBox="0 0 780 500" className="h-6 w-auto mb-1" aria-label="Visa">
                  ...
                  <span className="text-[10px] font-semibold text-gray-500">Visa</span>
                </div>

                <div className="flex flex-col items-center justify-center bg-white rounded-xl p-4 h-20 shadow-sm">
                  <svg viewBox="0 0 131.39 86.9" className="h-6 w-auto mb-1" aria-label="Mastercard">
                  ...
                  <span className="text-[10px] font-semibold text-gray-500">Mastercard</span>
                </div>

                <div className="flex flex-col items-center justify-center bg-black rounded-xl p-4 h-20 shadow-sm">
                  <svg viewBox="0 0 165.52 105.96" className="h-5 w-auto mb-1" aria-label="Apple Pay">
                  ...
                  <span className="text-[10px] font-semibold text-gray-400">Apple Pay</span>
                </div>

                <div className="flex flex-col items-center justify-center bg-white rounded-xl p-4 h-20 shadow-sm">
                  <svg className="h-6 w-6 text-navy mb-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-label="Virement">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M3 10h18M7 15h1m4 0h1m-7 4h12a3 3 0 003-3V8a3 3 0 00-3-3H6a3 3 0 00-3 3v8a3 3 0 003 3z"/>
                  </svg>
                  <span className="text-[10px] font-semibold text-gray-500">Virement</span>
                </div>

                <div className="flex flex-col items-center justify-center bg-white rounded-xl p-4 h-20 shadow-sm">
                  <svg className="h-6 w-6 text-navy mb-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-label="Chèque">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/>
                  </svg>
                  <span className="text-[10px] font-semibold text-gray-500">Chèque</span>
                </div>

                <div className="flex flex-col items-center justify-center bg-white rounded-xl p-4 h-20 shadow-sm">
                  <svg className="h-6 w-6 text-navy mb-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-label="Espèces">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M17 9V7a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2m2 4h10a2 2 0 002-2v-6a2 2 0 00-2-2H9a2 2 0 00-2 2v6a2 2 0 002 2zm7-5a2 2 0 11-4 0 2 2 0 014 0z"/>
                  </svg>
                  <span className="text-[10px] font-semibold text-gray-500">Espèces</span>
                </div>
              </div>

              <div className="border-t border-white/10 pt-8">
                <p className="text-white/80 text-sm font-semibold mb-4">Payer en ligne maintenant :</p>
                <PaiementButtons />
              </div>

              <p className="text-white/40 text-xs text-center mt-6">Paiement en ligne sécurisé par Mollie — transactions chiffrées SSL</p>
            </div>
